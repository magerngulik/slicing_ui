...
import '../view/browse_food_view.dart';

class BrowseFoodController extends State<BrowseFoodView>
    implements MvcController {
  static late BrowseFoodController instance;
  late BrowseFoodView view;
  ...
  List<Map> product = [
    {
      "name": "Rich Table",
      "category": "Chinese American Deshi food",
      "rating": "4.3",
      "countRating": "200+ Ratings",
      "time": "25 Min",
      "price": "free",
      "image":

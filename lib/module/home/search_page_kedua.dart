...
class SearchPageKedua extends StatefulWidget {
  const SearchPageKedua({Key? key}) : super(key: key);

  @override
  State<SearchPageKedua> createState() => _SearchPageKeduaState();
}

class _SearchPageKeduaState extends State<SearchPageKedua> {
  @override
